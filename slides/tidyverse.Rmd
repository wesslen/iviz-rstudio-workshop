...
## More advanced tidytext (see [tidytext Book](https://www.tidytextmining.com/twitter.html#comparing-word-usage))
...
Open **01-russian-trolls.R** file. 

```{r out.width = "500px", fig.align="center"}
knitr::include_graphics("./img/tidyverse/economist.png")
```
[Topic Modeling of Russian Troll Tweets](https://rawgit.com/wesslen/russian-troll-tweets/master/RussianTrolls.html)
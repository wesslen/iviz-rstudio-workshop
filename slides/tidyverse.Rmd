...
g <- ggplot(df2, aes(x = Hour, y = Count, frame = Weekday)) + 
...
gganimate(g, interval = 3)
```

## ggplot extensions

```{r out.width = "800px", fig.align="center"}
knitr::include_graphics("./img/tidyverse/ggextension.png")
```

[ggextensions](http://www.ggplot2-exts.org/gallery/)
...
[tidytext Book](https://www.tidytextmining.com/twitter.html#comparing-word-usage)
